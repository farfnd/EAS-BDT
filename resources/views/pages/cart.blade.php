          ...
          <div class="flex content-center items-center space-x-4 rounded-lg shadow-custom1 p-4">
            ...
            <div class="flex flex-col flex-grow h-full">
              ...
              <div class="flex justify-end items-center mt-auto">
                <p class="text-gray-400 hover:text-blue-500 cursor-pointer">Pindahkan ke Wishlist</p>
                <p class="text-gray-400">&nbsp;|&nbsp;</p>
                <div class="flex flex-col align-center"><i class='text-2xl text-gray-400 hover:text-blue-500 cursor-pointer bx bx-trash'></i></div>
                <p class="text-gray-400">&nbsp;|&nbsp;</p>
                <div class="flex space-x-2">
                  <i class='text-2xl text-gray-400 hover:text-blue-500 cursor-pointer bx bx-minus'></i>
