        ...
        <div class="flex flex-col space-y-5 mx-8 mt-4 mb-6">
            ...
            @for ($i = 0; $i < 2; $i++)
                ...
                <div class="modal micromodal-slide" id="lacak-item" aria-hidden="true">
                    ...
                    <div class="modal__container h-52" role="dialog" 
                        aria-modal="true" aria-labelledby="lacak-item-title"
                            ...
                            <main class="modal__content mt-3" id="lacak-item-content">
                                <div class="grid grid-cols-12">
                                    <div class="col-span-5 flex flex-col space-y-4  mr-4">
                                        ...
                                        <img class="w-40" src="{{asset('images/jacket.png')}}" alt="" class="item-image">
                                        <p class="font-bold text-lg">Sweater Logo Fav Maroon</p>
                                    </div>
                                    <div class="text-sm md:text-base font-bold col-span-7 flex flex-col justify-center border-l-2 pl-4">
                                        <div class="mb-2">
                ...
                <div class="modal micromodal-slide" id="beri-ulasan" aria-hidden="true">
                    ...
                    <div class="modal__container h-52" role="dialog" 
                        ...
                        style="height: 30rem; width: 50rem; display: flex; 
                                ...
                                <div class="grid grid-cols-12">
                                    ...
                                    <form action="" method="POST">
                                        <div class="flex flex-col">
                                            ...
                                            <textarea placeholder="Masukan ulasan anda" class="rounded-md shadow-custom1" name="" id="komentar" cols="30" rows="5" style="resize: none; border: none"></textarea>
                                        </div>
                                        <div class="flex mt-8">
                                            <div class="mr-8">
                                                    <p class="mb-2 ">Unggah Foto:</p>
                                                    <label for="file-upload" class="custom-file-upload cursor-pointer">
                                                    <p class="bg-gray-700 text-regular text-white shadow-md hover:shadow-lg rounded-md px-4 py-1">Upload Files</p>
                                                    </label>
