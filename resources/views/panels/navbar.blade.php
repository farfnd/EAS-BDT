<div class="flex flex-row my-4 bg-green-100">
  <div>
    <h2 class="font-arial font-semibold text-2xl md:text-4xl">HANAKA &amp; CO.</h2>
  ...
  <div class="ml-auto align-bottom justify-center">
    <ul class="flex flex-row space-x-4 h-full text-sm md:text-base">
      ...
      <!-- IF LOGIN -->
      <li class="block my-auto font-semibold"><a href="" class="flex flex-row justify-center items-center hover:opacity-80"><i class='bx bx-user bx-sm'></i></a></li>
      <li class="block my-auto font-semibold"><a href="" class="flex flex-row justify-center items-center hover:opacity-80"><i class='bx bx-cart bx-sm'></i></a></li>
